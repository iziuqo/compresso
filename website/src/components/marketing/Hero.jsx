    ...
    <section className="mk-hero" id="top">
      <div className="mk-wrap mk-hero__inner">
        ...
        <a className="mk-shot mk-shot--hero mk-shot--flush" href={APP_URL} aria-label={t.hero.cta}>
          ...
          <picture>
            <source media="(max-width: 639.98px)" type="image/avif" srcSet="/app/app-mobile-dark.avif" width={780} height={1688} />
            <source media="(max-width: 639.98px)" type="image/webp" srcSet="/app/app-mobile-dark.webp" width={780} height={1688} />
